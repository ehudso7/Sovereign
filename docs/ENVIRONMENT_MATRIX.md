...
| `RAILWAY_TOKEN_STAGING`             | staging    | Railway project token for staging deploys         |
| `RAILWAY_TOKEN_PRODUCTION`          | production | Railway project token for production deploys      |
| `DATABASE_URL_STAGING`              | staging    | Staging database URL for GitHub-run migrations    |
| `DATABASE_URL_PRODUCTION`           | production | Production database URL for GitHub-run migrations |
...
| Variable                           | Description                                 |
| ---------------------------------- | ------------------------------------------- |
| `TEMPORAL_TASK_QUEUE`              | Task queue name (default: `sovereign-runs`) |
...
| Variable             | Example                                                |
| -------------------- | ------------------------------------------------------ |
| `TEMPORAL_ADDRESS`   | `<namespace_id>.<account_id>.tmprl.cloud:7233`         |
